		    ...
		    <h3 class="form-signin-heading"> Address Form !!</h3>
			  <hr class="colorgraph"><br>
			        <div class="form-group">
                                    ...
                                    <input type="text"  value="${address.street}" class="form-control" id="street" name="street" required>
                                </div>
                          
         		     <div class="form-group">
			      <label for="city">City:</label>
			      <input type="text" value="${address.city}" class="form-control" id="city" name="city" required>
			    </div>
			    <div class="form-group">
			      <label for="state">State:</label>
			      <input type="text" value="${address.state}" class="form-control" id="state" name="state" required>
			    </div>
                          <div class="form-group">
			      <label for="country">Country:</label>
			      <input type="text" value="${address.country}" class="form-control" id="country" name="country" required>
			    </div>
